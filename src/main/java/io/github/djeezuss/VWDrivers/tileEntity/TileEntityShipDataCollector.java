...
public class TileEntityShipDataCollector extends TileEntity implements SimpleComponent{
	
	@Override
	public String getComponentName() {
		return "ship_data_collector";
	}
	...
	public Object[] greet(Context context, Arguments args) {
		return new Object[] { String.format("Welcome aboard, %s!", args.checkString(0)) };
	}
	...
	public Object[] setYaw(Context context, Arguments args) {
		if(ValkyrienWarfareHooks.isBlockPartOfShip(worldObj, pos)) {
			ValkyrienWarfareHooks.getShipEntityManagingPos(worldObj, pos).yaw = 0.0D;
		}
		return new Object[] { null };
	}
}
